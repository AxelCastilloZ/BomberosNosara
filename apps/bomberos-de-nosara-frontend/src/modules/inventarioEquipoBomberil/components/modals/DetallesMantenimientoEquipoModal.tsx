...
export const DetallesMantenimientoEquipoModal: React.FC<DetallesMantenimientoModalProps> = ({
  mantenimiento,
  open,
  onOpenChange,
}) => {
              ...
              <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium text-gray-900">
                      {equipo ? getTipoEquipoLabel(equipo.tipo) : 'N/A'}
                    </p>
                  </div>
                  <div>
                    <p className="text-xs text-gray-500">Estado Actual del Equipo</p>
                    <p className="text-sm font-medium text-gray-900">
                      {equipo ? getEstadoEquipoLabel(equipo.estadoActual) : 'N/A'}
                    </p>
                  </div>
                </div>
              </div>
