...
export const EditarMantenimientoModal: React.FC<EditarMantenimientoModalProps> = ({
  ...
  const footerContent = (
    <>
      ...
      <Button
        type="submit"
        form="editar-mantenimiento-form"
        disabled={editMantenimientoMutation.isPending}
      >
  ...
  return (
    <BaseModal
      ...
      description={`${mantenimiento.equipo?.nombre || 'Equipo'} • ${mantenimiento.equipo?.numeroSerie || ''}`}
      size="md"
      footerContent={footerContent}
    >
      <form id="editar-mantenimiento-form" onSubmit={handleSubmit(onSubmit)}>
