...
export const CompletarMantenimientoEquipoModal: React.FC<CompletarMantenimientoModalProps> = ({
  ...
  const footerContent = (
    <>
      ...
      <Button 
        type="submit" 
        form="completar-mantenimiento-equipo-form"
  ...
  return (
    <BaseModal
      ...
      description="Finaliza un mantenimiento pendiente registrando los detalles de la ejecución"
      size="xl"
    ...
    >
      {isLoading ? (
        ...
        <form id="completar-mantenimiento-equipo-form" onSubmit={handleSubmit(onSubmit)}>
