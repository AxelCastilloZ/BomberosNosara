...
export const TabPorPeriodo: React.FC = () => {
  ...
  const handleEditar = (mantenimiento: MantenimientoEquipo) => {
  ...
  const handleCompletar = (mantenimiento: MantenimientoEquipo) => {
    setMantenimientoSeleccionado(mantenimiento);
  ...
  const handleVerDetalles = (mantenimiento: MantenimientoEquipo) => {
    setMantenimientoSeleccionado(mantenimiento);
                    ...
                    <td className="px-6 py-4 text-sm font-medium text-gray-900">
                      <div className="max-w-xs">
                        <div className="font-semibold">
                          {mantenimiento.equipo?.numeroSerie || 'N/A'}
                        </div>
