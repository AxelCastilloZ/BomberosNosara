...
export const ProgramarMantenimientoModal: React.FC<ProgramarMantenimientoModalProps> = ({
  ...
  const onSubmit = async (data: ProgramarMantenimientoFormData) => {
    ...
    try {
      ...
      // ✅ vehiculoId NO se envía en el body, solo tipo, fecha, descripcion, observaciones
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      ...
      >
        <DialogHeader className="px-6 pt-6 pb-4 border-b">
          ...
          <DialogDescription>
            Agenda un mantenimiento futuro para un vehículo
          </DialogDescription>
        </DialogHeader>
        ...
        >
          ...
          <DialogFooter className="px-6 py-4 border-t">
            ...
            <Button type="submit" disabled={isSubmitting || isLoadingVehiculos}>
