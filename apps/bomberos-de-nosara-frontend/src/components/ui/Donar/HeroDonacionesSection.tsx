    ...
    <div className="max-w-4xl mx-auto px-4 py-20 sm:py-28 lg:py-32 text-center">
      ...
      <div className="mt-12">
        <a
          ...
          className="bg-red-800 hover:bg-red-700 text-white font-bold py-3 px-8 rounded-full text-lg transition-all duration-300 transform hover:-translate-y-1 hover:scale-105 inline-block"
        >
