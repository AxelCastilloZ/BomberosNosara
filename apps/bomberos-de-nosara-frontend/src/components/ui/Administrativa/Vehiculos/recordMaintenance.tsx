...
import { useRegistrarMantenimiento } from '../../../../hooks/useVehiculos';
...
export default function RecordMaintenance({ vehiculoId, onClose }: Props) {
  ...
  const handleSubmit = () => {
    if (!vehiculoSeleccionado || !fecha || !descripcion || !kilometraje || !tecnico || !costo) return;
  ...
  <div className="bg-white border border-gray-300 shadow rounded-lg p-6 max-w-4xl mx-auto">
    ...
    <div className="flex justify-end gap-2 mt-6">
      ...
      <button
        ...
        disabled={!vehiculoSeleccionado || !fecha || !descripcion || !kilometraje || !tecnico || !costo}
