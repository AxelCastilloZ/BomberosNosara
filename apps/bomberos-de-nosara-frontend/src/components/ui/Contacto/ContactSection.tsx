...
export default function ContactSection() {
  return (
    <>
      {/* Aporte de feature/footer: hero de contacto (si existe en tu proyecto) */}
      <HeroContact />

      <footer id="contact" className="w-full bg-red-800 text-white px-6 pt-12 pb-2">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left space-y-4">
            ...
            <p className="text-gray-100 max-w-xs">
              Ayudamos a garantizar servicios de emergencia oportunos para la comunidad
              porque, en caso de emergencia, ¡cada segundo cuenta!
            </p>
          ...
          {/* Columna centro (aporta feature/footer: textos del data) */}
          <div className="flex flex-col items-center md:items-start text-center md:text-left space-y-3">
            {Array.isArray(contactParagraphs) && contactParagraphs.length > 0 ? (
              contactParagraphs.map((t, i) => (
                <p key={i} className="text-gray-100/90">{t}</p>
              ))
            ) : (
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left space-y-4">
            ...
            <p className="flex items-center gap-2">
              ...
              <span>
                Teléfono:{" "}
                <a href="tel:+50687090614" className="underline hover:text-gray-200">
                  +506 8709 0614
                </a>
              </span>
            </p>
            <p className="flex items-center gap-2">
              ...
              <span>
                Email:{" "}
                <a href="mailto:info@bomberosnosara.org" className="underline hover:text-gray-200">
            ...
            <motion.a
              ...
              className="bg-white text-red-700 font-bold px-6 py-3 rounded-md shadow flex items-center gap-2 hover:bg-gray-100 transition"
